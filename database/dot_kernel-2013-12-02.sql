...
--
-- Host: localhost
-- Generation Time: Dec 02, 2013 at 03:51 AM
...
CREATE TABLE IF NOT EXISTS `activity_log` (
  `idactivity_log` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `iduser_id` int(11) unsigned DEFAULT NULL,
  `activity` varchar(255) DEFAULT NULL,
  `activity_description` tinytext,
  `system_id` varchar(155) DEFAULT NULL,
  `iduserlogin_id` int(11) unsigned DEFAULT NULL,
  `activity_time` int(11) unsigned DEFAULT NULL,
  PRIMARY KEY (`idactivity_log`),
  KEY `IN_IDUSER_ID` (`iduser_id`),
  KEY `IN_IDUSERLOGIN_ID` (`iduserlogin_id`)
...
INSERT INTO `activity_log` (`idactivity_log`, `iduser_id`, `activity`, `activity_description`, `system_id`, `iduserlogin_id`, `activity_time`) VALUES
(2, 1, 'aaa', 'sadsa', NULL, NULL, 1385950175),
(3, 1, 'aaa', 'sadsa', NULL, NULL, 1385950377);
...
(5, '127.0.0.1', 1, 'http://dotkernel.me/admin/admin/login', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36', '2013-11-28 17:15:54'),
(6, '127.0.0.1', 1, 'http://dotkernel.me/admin/admin/login', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36', '2013-11-28 17:16:22'),
(7, '127.0.0.1', 1, 'http://dotkernel.me/admin/admin/login', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36', '2013-11-29 08:19:17'),
(8, '127.0.0.1', 1, 'http://dotkernel.me/admin/admin/login', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/534.57.2 (KHTML, like Gecko) Version/5.1.7 Safari/534.57.2', '2013-11-29 09:21:44');
...
DROP TABLE IF EXISTS `emailtransporter`;
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  `menu_type` tinyint(1) unsigned DEFAULT NULL,
...
INSERT INTO `menu` (`idmenu`, `menu_title`, `menu_alias`, `menu_type`, `path`, `is_deleted`) VALUES
(1, 'Home', 'home', 1, '/page/home', 0),
(2, 'About', 'page-about', 2, '/page/about', 0),
(3, 'Who we are', 'who-we-are', 1, '/page/who-we-are', 0),
(4, 'Coding standard', 'coding-standard', 1, '/page/coding-standard', 0);
...
(1, 'admin', 'admin123', 'admin@yopmail.com', 'Hoangzzzzzzz', 'Nguyen222222', '2013-11-26 09:51:32', '1');
...
(3, '127.0.0.1', 'NA', 1, 'http://dotkernel.me/user/login', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36', '2013-11-29 08:19:03'),
(4, '127.0.0.1', 'NA', 1, 'http://dotkernel.me/user/login', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.57 Safari/537.36', '2013-12-02 01:59:25');
...
ALTER TABLE `activity_log`
  ADD CONSTRAINT `fk_activity_log_1` FOREIGN KEY (`iduser_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_activity_log_2` FOREIGN KEY (`iduserlogin_id`) REFERENCES `userlogin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
