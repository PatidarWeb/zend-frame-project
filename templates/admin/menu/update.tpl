    ...
    <fieldset style="width: 500px">
        ...
        <table class="medium_table">
            ...
            <tr>
                <td><b>Show on</b></td>
                <td>
                    <select name="menu_type" class="select" >
    ...
    <fieldset style="width: 500px">
        <table class="medium_table visible">
            ...
            <tr>
                ...
                <td>
                <!-- BEGIN menu_top -->
                <input type="checkbox" name="{NAME_1}" value="{VALUE_1}"{CHECKED} />{MENU_TITLE_1}<br>
                <!-- END menu_top -->
                </td>
            </tr>
            <tr>
                ...
                <td>
                <!-- BEGIN menu_left -->
                <input type="checkbox" name="{NAME_2}" value="{VALUE_2}" {CHECKED}/>{MENU_TITLE_2}<br/>
                <!-- END menu_left -->
                </td>
            </tr>
            <tr>
                ...
                <td>
                <!-- BEGIN menu_bottom -->
                <input type="checkbox" name="{NAME_3}" value="{VALUE_3}" {CHECKED} />{MENU_TITLE_3}<br/>
                <!-- END menu_bottom -->
                </td>   
            </tr>
            <tr>
