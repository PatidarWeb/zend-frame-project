<form action="{SITE_URL}/admin/menu/delete/id/{IDMENU}" method="post" >
	...
	<table class="medium_table">
		<tr>
			...
			<td style="vertical-align: middle;">
				...
				<input type="button" onclick="window.location = '{SITE_URL}/admin/menu/list'" class="button" value="Cancel">
			</td>
		</tr>
	</table>
</fieldset>
